  ...
  <div className={className}>
    ...
    <div className='row'>
      <TopBanner className='col-xs-12'>
        ...
        >
          <HighlightLetters>A</HighlightLetters>dam{' '}
          <Surname>
            <HighlightLetters>C</HighlightLetters>hilton
          </Surname>
        </H1>
      </TopBanner>
    </div>
    ...
    <div className='row'>
      {showRestOfSite ? <RestOfSite className='col-xs-12' /> : null}
    </div>
  </div>
)
...
const DefaultSandbox = styled(Sandbox)`
  background-color: ${(props) =>
    props.theme.color.background || 'rgba(0,0,0,0.01)'};
`
